 ...
 */
export type GQLCommentSort = 'oldest' | 'newest'
...
export type GQLSocialAccountType = 'Google' | 'Twitter' | 'Facebook'
...
export type GQLTagArticlesSortBy = 'byHottestDesc' | 'byCreatedAtDesc'
...
export type GQLQuoteCurrency = 'TWD' | 'HKD' | 'USD'
...
export interface GQLRecommendationFollowingInput {
  first?: number
  after?: string
  filter?: GQLRecommendationFollowingFilterInput
}

export interface GQLRecommendationFollowingFilterInput {
...
export interface GQLFollowingActivityNameMap {
  ...
  UserPostMomentActivity: GQLUserPostMomentActivity
...
export interface GQLUserPostMomentActivity {
  actor: GQLUser
  createdAt: GQLDateTime
...
export interface GQLMoment extends GQLNode {
  id: string
  shortHash: string
  content?: string
  assets: Array<GQLAsset>
...
export type GQLIcymiTopicState = 'published' | 'editing' | 'archived'
...
export interface GQLWritingInput {
  after?: string
  first?: number
}

export interface GQLWritingConnection extends GQLConnection {
  totalCount: number
  pageInfo: GQLPageInfo
  edges?: Array<GQLWritingEdge>
}

export interface GQLWritingEdge {
  cursor: string
  node: GQLWriting
}
...
/** Use this to resolve union type Writing */
export type GQLPossibleWritingTypeNames = 'Article' | 'Moment'

export interface GQLWritingNameMap {
  Writing: GQLWriting
  Article: GQLArticle
  Moment: GQLMoment
}
 ...
 */
export type GQLPublishState = 'unpublished' | 'pending' | 'error' | 'published'
 ...
 */
export type GQLArticleAccessType = 'public' | 'paywall'
...
/** Use this to resolve interface type Campaign */
export type GQLPossibleCampaignTypeNames = 'WritingChallenge'

export interface GQLCampaignNameMap {
  Campaign: GQLCampaign
  WritingChallenge: GQLWritingChallenge
}

export type GQLCampaignState = 'pending' | 'active' | 'finished' | 'archived'
...
export interface GQLCampaignConnection extends GQLConnection {
  totalCount: number
  pageInfo: GQLPageInfo
  edges?: Array<GQLCampaignEdge>
}

export interface GQLCampaignEdge {
  cursor: string
  node: GQLCampaign
}
...
export type GQLUserState = 'active' | 'banned' | 'archived' | 'frozen'
...
export type GQLChain = 'Polygon' | 'Optimism'
...
export interface GQLSpamStatus {
  /**
 ...
 */
export type GQLResponseSort = 'oldest' | 'newest'
...
export interface GQLCampaignInput {
  shortHash: string
}

export interface GQLCampaignsInput {
  after?: string
  first?: number
...
export type GQLSearchTypes = 'Article' | 'User' | 'Tag'
...
export type GQLSearchAPIVersion = 'v20230601' | 'v20230301'
...
export interface GQLOSSArticlesInput {
  after?: string
  first?: GQLfirst_Int_min_0
  filter?: GQLOSSArticlesFilterInput
}

export interface GQLOSSArticlesFilterInput {
  isSpam?: boolean
}
 ...
 */
export type GQLTagsSort = 'newest' | 'oldest' | 'hottest'
...
export type GQLSkippedListItemType = 'agent_hash' | 'email' | 'domain'
...
export interface GQLMomentInput {
  shortHash: string
}
...
export interface GQLEditArticleInput {
   ...
   */
  campaigns?: Array<GQLArticleCampaignInput>
}
...
export interface GQLArticleCampaignInput {
  campaign: string
  stage: string
}
 ...
 */
export type GQLRecommendTypes = 'icymi' | 'hottest' | 'newest' | 'search'
...
export interface GQLTranslationInput {
  language: GQLUserLanguage
  text: string
}

export interface GQLDatetimeRangeInput {
  start: GQLDateTime
  end?: GQLDateTime
}
...
export interface GQLWritingChallenge extends GQLNode, GQLCampaign {
  id: string
  shortHash: string
  name: string
  description?: string
...
export interface GQLCampaignParticipantsInput {
  after?: string
  first?: number
...
export interface GQLCampaignParticipantConnection extends GQLConnection {
  totalCount: number
  pageInfo: GQLPageInfo
  edges?: Array<GQLCampaignParticipantEdge>
}

export interface GQLCampaignParticipantEdge {
  cursor: string
  application?: GQLCampaignApplication
  node: GQLUser
}

export interface GQLCampaignApplication {
  state: GQLCampaignApplicationState
  createdAt: GQLDateTime
}

export type GQLCampaignApplicationState = 'pending' | 'succeeded' | 'rejected'

export interface GQLCampaignArticlesInput {
  after?: string
  first?: number
  filter?: GQLCampaignArticlesFilter
}

export interface GQLCampaignArticlesFilter {
  stage: string
}

export interface GQLCampaignOSS {
  boost: number
}

export interface GQLApplyCampaignInput {
  id: string
}

export interface GQLUpdateCampaignApplicationStateInput {
  campaign: string
  user: string
  state: GQLCampaignApplicationState
}
...
export type GQLBoostTypes = 'Article' | 'User' | 'Tag' | 'Campaign'
...
export type GQLFeatureFlag = 'on' | 'off' | 'admin' | 'seeding'
...
export interface GQLSetSpamStatusInput {
  id: string
  isSpam: boolean
}
...
export type GQLAuthResultType = 'Login' | 'Signup' | 'LinkAccount'
...
export interface GQLLikeCollectionInput {
  id: string
}

export interface GQLUnlikeCollectionInput {
  id: string
}

export interface GQLPutMomentInput {
  content: string
  assets: Array<string>
}

export interface GQLDeleteMomentInput {
  id: string
}

export interface GQLLikeMomentInput {
  id: string
}

export interface GQLUnlikeMomentInput {
  id: string
}
...
export type GQLCacheControlScope = 'PUBLIC' | 'PRIVATE'
...
export interface GQLCollectionNotice extends GQLNotice {
  /**
   * Unique ID of this notice.
   */
  id: string
...
export interface GQLMomentNotice extends GQLNotice {
  /**
   * Unique ID of this notice.
   */
  id: string
...
export type GQLMomentNoticeType = 'MomentMentionedYou' | 'MomentLiked'
 ...
 */
export type GQLRole = 'vistor' | 'user' | 'admin'
...
export interface GQLResolver {
  ...
  UserPostMomentActivity?: GQLUserPostMomentActivityTypeResolver
  Moment?: GQLMomentTypeResolver
  ...
  WritingConnection?: GQLWritingConnectionTypeResolver
  WritingEdge?: GQLWritingEdgeTypeResolver
  Writing?: {
    __resolveType: GQLWritingTypeResolver
  }
  ...
  ArticleCampaign?: GQLArticleCampaignTypeResolver
  Campaign?: {
    __resolveType: GQLCampaignTypeResolver
  }

  CampaignStage?: GQLCampaignStageTypeResolver
  DatetimeRange?: GQLDatetimeRangeTypeResolver
  ...
  CampaignConnection?: GQLCampaignConnectionTypeResolver
  CampaignEdge?: GQLCampaignEdgeTypeResolver
  ...
  SpamStatus?: GQLSpamStatusTypeResolver
  ...
  WritingChallenge?: GQLWritingChallengeTypeResolver
  CampaignParticipantConnection?: GQLCampaignParticipantConnectionTypeResolver
  CampaignParticipantEdge?: GQLCampaignParticipantEdgeTypeResolver
  CampaignApplication?: GQLCampaignApplicationTypeResolver
  CampaignOSS?: GQLCampaignOSSTypeResolver
...
export interface GQLQueryTypeResolver<TParent = any> {
  ...
  campaign?: QueryToCampaignResolver<TParent>
  campaigns?: QueryToCampaignsResolver<TParent>
  ...
  moment?: QueryToMomentResolver<TParent>
}
...
export interface QueryToCampaignArgs {
  input: GQLCampaignInput
}
export interface QueryToCampaignResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: QueryToCampaignArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface QueryToCampaignsArgs {
  input: GQLCampaignsInput
}
export interface QueryToCampaignsResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: QueryToCampaignsArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}
...
export interface QueryToMomentArgs {
  input: GQLMomentInput
}
export interface QueryToMomentResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: QueryToMomentArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}
...
export interface GQLArticleTypeResolver<TParent = any> {
  ...
  donated?: ArticleToDonatedResolver<TParent>
  ...
  campaigns?: ArticleToCampaignsResolver<TParent>
...
export interface ArticleToDonatedResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface ArticleToCampaignsResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLUserTypeResolver<TParent = any> {
  ...
  writings?: UserToWritingsResolver<TParent>
  ...
  campaigns?: UserToCampaignsResolver<TParent>
...
export interface UserToWritingsArgs {
  input: GQLWritingInput
}
export interface UserToWritingsResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: UserToWritingsArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}
...
export interface UserToCampaignsArgs {
  input: GQLConnectionArgs
}
export interface UserToCampaignsResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: UserToCampaignsArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}
...
export interface GQLNotificationSettingTypeResolver<TParent = any> {
  ...
  newComment?: NotificationSettingToNewCommentResolver<TParent>
  newLike?: NotificationSettingToNewLikeResolver<TParent>
...
export interface NotificationSettingToNewCommentResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface NotificationSettingToNewLikeResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLUserPostMomentActivityTypeResolver<TParent = any> {
  actor?: UserPostMomentActivityToActorResolver<TParent>
  createdAt?: UserPostMomentActivityToCreatedAtResolver<TParent>
  node?: UserPostMomentActivityToNodeResolver<TParent>
  more?: UserPostMomentActivityToMoreResolver<TParent>
}

export interface UserPostMomentActivityToActorResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface UserPostMomentActivityToCreatedAtResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface UserPostMomentActivityToNodeResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface UserPostMomentActivityToMoreResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLMomentTypeResolver<TParent = any> {
  id?: MomentToIdResolver<TParent>
  shortHash?: MomentToShortHashResolver<TParent>
  content?: MomentToContentResolver<TParent>
  assets?: MomentToAssetsResolver<TParent>
  author?: MomentToAuthorResolver<TParent>
  state?: MomentToStateResolver<TParent>
  commentCount?: MomentToCommentCountResolver<TParent>
  commentedFollowees?: MomentToCommentedFolloweesResolver<TParent>
  comments?: MomentToCommentsResolver<TParent>
  likeCount?: MomentToLikeCountResolver<TParent>
  liked?: MomentToLikedResolver<TParent>
  createdAt?: MomentToCreatedAtResolver<TParent>
}

export interface MomentToIdResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToShortHashResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToContentResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToAssetsResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToAuthorResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToStateResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToCommentCountResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToCommentedFolloweesResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface MomentToCommentsArgs {
  input: GQLCommentsInput
}
export interface MomentToCommentsResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: MomentToCommentsArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface MomentToLikeCountResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToLikedResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentToCreatedAtResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLWritingConnectionTypeResolver<TParent = any> {
  totalCount?: WritingConnectionToTotalCountResolver<TParent>
  pageInfo?: WritingConnectionToPageInfoResolver<TParent>
  edges?: WritingConnectionToEdgesResolver<TParent>
}

export interface WritingConnectionToTotalCountResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface WritingConnectionToPageInfoResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface WritingConnectionToEdgesResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLWritingEdgeTypeResolver<TParent = any> {
  cursor?: WritingEdgeToCursorResolver<TParent>
  node?: WritingEdgeToNodeResolver<TParent>
}

export interface WritingEdgeToCursorResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface WritingEdgeToNodeResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLWritingTypeResolver<TParent = any> {
  (parent: TParent, context: Context, info: GraphQLResolveInfo):
    | 'Article'
    | 'Moment'
    | Promise<'Article' | 'Moment'>
}
...
export interface GQLCollectionTypeResolver<TParent = any> {
  ...
  likeCount?: CollectionToLikeCountResolver<TParent>
  liked?: CollectionToLikedResolver<TParent>
...
export interface CollectionToLikeCountResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface CollectionToLikedResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLDraftTypeResolver<TParent = any> {
  ...
  campaigns?: DraftToCampaignsResolver<TParent>
}
...
export interface DraftToCampaignsResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLArticleCampaignTypeResolver<TParent = any> {
  campaign?: ArticleCampaignToCampaignResolver<TParent>
  stage?: ArticleCampaignToStageResolver<TParent>
}

export interface ArticleCampaignToCampaignResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface ArticleCampaignToStageResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLCampaignTypeResolver<TParent = any> {
  (parent: TParent, context: Context, info: GraphQLResolveInfo):
    | 'WritingChallenge'
...
export interface CampaignStageToIdResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface CampaignStageToNameArgs {
  input?: GQLTranslationArgs
}
export interface CampaignStageToNameResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
...
export interface CampaignStageToPeriodResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLDatetimeRangeTypeResolver<TParent = any> {
  start?: DatetimeRangeToStartResolver<TParent>
  end?: DatetimeRangeToEndResolver<TParent>
}

export interface DatetimeRangeToStartResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface DatetimeRangeToEndResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLCampaignConnectionTypeResolver<TParent = any> {
  totalCount?: CampaignConnectionToTotalCountResolver<TParent>
  pageInfo?: CampaignConnectionToPageInfoResolver<TParent>
  edges?: CampaignConnectionToEdgesResolver<TParent>
}

export interface CampaignConnectionToTotalCountResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CampaignConnectionToPageInfoResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CampaignConnectionToEdgesResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLCampaignEdgeTypeResolver<TParent = any> {
  cursor?: CampaignEdgeToCursorResolver<TParent>
  node?: CampaignEdgeToNodeResolver<TParent>
}

export interface CampaignEdgeToCursorResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface CampaignEdgeToNodeResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLUserStatusTypeResolver<TParent = any> {
  ...
  momentCount?: UserStatusToMomentCountResolver<TParent>
...
export interface UserStatusToMomentCountResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLArticleOSSTypeResolver<TParent = any> {
  ...
  inSearch?: ArticleOSSToInSearchResolver<TParent>
  spamStatus?: ArticleOSSToSpamStatusResolver<TParent>
}
...
export interface ArticleOSSToInSearchResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface ArticleOSSToSpamStatusResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLSpamStatusTypeResolver<TParent = any> {
  score?: SpamStatusToScoreResolver<TParent>
  isSpam?: SpamStatusToIsSpamResolver<TParent>
}

export interface SpamStatusToScoreResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface SpamStatusToIsSpamResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLFeatureTypeResolver<TParent = any> {
  ...
  value?: FeatureToValueResolver<TParent>
}
...
export interface FeatureToValueResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLMutationTypeResolver<TParent = any> {
  ...
  putWritingChallenge?: MutationToPutWritingChallengeResolver<TParent>
  applyCampaign?: MutationToApplyCampaignResolver<TParent>
  updateCampaignApplicationState?: MutationToUpdateCampaignApplicationStateResolver<
    TParent
  >
  ...
  setSpamStatus?: MutationToSetSpamStatusResolver<TParent>
  ...
  reorderCollectionArticles?: MutationToReorderCollectionArticlesResolver<
    TParent
  >
  likeCollection?: MutationToLikeCollectionResolver<TParent>
  unlikeCollection?: MutationToUnlikeCollectionResolver<TParent>
  putMoment?: MutationToPutMomentResolver<TParent>
  deleteMoment?: MutationToDeleteMomentResolver<TParent>
  likeMoment?: MutationToLikeMomentResolver<TParent>
  unlikeMoment?: MutationToUnlikeMomentResolver<TParent>
}
...
export interface MutationToPutWritingChallengeArgs {
  input: GQLPutWritingChallengeInput
}
export interface MutationToPutWritingChallengeResolver<
  TParent = any,
  TResult = any
> {
  (
    parent: TParent,
    args: MutationToPutWritingChallengeArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface MutationToApplyCampaignArgs {
  input: GQLApplyCampaignInput
}
export interface MutationToApplyCampaignResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: MutationToApplyCampaignArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface MutationToUpdateCampaignApplicationStateArgs {
  input: GQLUpdateCampaignApplicationStateInput
}
export interface MutationToUpdateCampaignApplicationStateResolver<
  TParent = any,
  TResult = any
> {
  (
    parent: TParent,
    args: MutationToUpdateCampaignApplicationStateArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}
...
export interface MutationToSetSpamStatusArgs {
  input: GQLSetSpamStatusInput
}
export interface MutationToSetSpamStatusResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: MutationToSetSpamStatusArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}
...
export interface MutationToLikeCollectionArgs {
  input: GQLLikeCollectionInput
}
export interface MutationToLikeCollectionResolver<
  TParent = any,
  TResult = any
> {
  (
    parent: TParent,
    args: MutationToLikeCollectionArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface MutationToUnlikeCollectionArgs {
  input: GQLUnlikeCollectionInput
}
export interface MutationToUnlikeCollectionResolver<
  TParent = any,
  TResult = any
> {
  (
    parent: TParent,
    args: MutationToUnlikeCollectionArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface MutationToPutMomentArgs {
  input: GQLPutMomentInput
}
export interface MutationToPutMomentResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: MutationToPutMomentArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface MutationToDeleteMomentArgs {
  input: GQLDeleteMomentInput
}
export interface MutationToDeleteMomentResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: MutationToDeleteMomentArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface MutationToLikeMomentArgs {
  input: GQLLikeMomentInput
}
export interface MutationToLikeMomentResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: MutationToLikeMomentArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface MutationToUnlikeMomentArgs {
  input: GQLUnlikeMomentInput
}
export interface MutationToUnlikeMomentResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: MutationToUnlikeMomentArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface GQLWritingChallengeTypeResolver<TParent = any> {
  id?: WritingChallengeToIdResolver<TParent>
  shortHash?: WritingChallengeToShortHashResolver<TParent>
  name?: WritingChallengeToNameResolver<TParent>
  ...
  state?: WritingChallengeToStateResolver<TParent>
  participants?: WritingChallengeToParticipantsResolver<TParent>
  articles?: WritingChallengeToArticlesResolver<TParent>
  application?: WritingChallengeToApplicationResolver<TParent>
  oss?: WritingChallengeToOssResolver<TParent>
}

export interface WritingChallengeToIdResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface WritingChallengeToShortHashResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface WritingChallengeToNameArgs {
  input?: GQLTranslationArgs
}
export interface WritingChallengeToNameResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: WritingChallengeToNameArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface WritingChallengeToDescriptionArgs {
  input?: GQLTranslationArgs
}
export interface WritingChallengeToDescriptionResolver<
  TParent = any,
  TResult = any
> {
  (
    parent: TParent,
    args: WritingChallengeToDescriptionArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface WritingChallengeToCoverResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface WritingChallengeToApplicationPeriodResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface WritingChallengeToWritingPeriodResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface WritingChallengeToStagesResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface WritingChallengeToStateResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface WritingChallengeToParticipantsArgs {
  input: GQLCampaignParticipantsInput
}
export interface WritingChallengeToParticipantsResolver<
  TParent = any,
  TResult = any
> {
  (
    parent: TParent,
    args: WritingChallengeToParticipantsArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface WritingChallengeToArticlesArgs {
  input: GQLCampaignArticlesInput
}
export interface WritingChallengeToArticlesResolver<
  TParent = any,
  TResult = any
> {
  (
    parent: TParent,
    args: WritingChallengeToArticlesArgs,
    context: Context,
    info: GraphQLResolveInfo
  ): TResult
}

export interface WritingChallengeToApplicationResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface WritingChallengeToOssResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLCampaignParticipantConnectionTypeResolver<TParent = any> {
  totalCount?: CampaignParticipantConnectionToTotalCountResolver<TParent>
  pageInfo?: CampaignParticipantConnectionToPageInfoResolver<TParent>
  edges?: CampaignParticipantConnectionToEdgesResolver<TParent>
}

export interface CampaignParticipantConnectionToTotalCountResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CampaignParticipantConnectionToPageInfoResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CampaignParticipantConnectionToEdgesResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLCampaignParticipantEdgeTypeResolver<TParent = any> {
  cursor?: CampaignParticipantEdgeToCursorResolver<TParent>
  application?: CampaignParticipantEdgeToApplicationResolver<TParent>
  node?: CampaignParticipantEdgeToNodeResolver<TParent>
}

export interface CampaignParticipantEdgeToCursorResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CampaignParticipantEdgeToApplicationResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CampaignParticipantEdgeToNodeResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLCampaignApplicationTypeResolver<TParent = any> {
  state?: CampaignApplicationToStateResolver<TParent>
  createdAt?: CampaignApplicationToCreatedAtResolver<TParent>
}

export interface CampaignApplicationToStateResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CampaignApplicationToCreatedAtResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLCampaignOSSTypeResolver<TParent = any> {
  boost?: CampaignOSSToBoostResolver<TParent>
}

export interface CampaignOSSToBoostResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface GQLCollectionNoticeTypeResolver<TParent = any> {
  id?: CollectionNoticeToIdResolver<TParent>
  unread?: CollectionNoticeToUnreadResolver<TParent>
  createdAt?: CollectionNoticeToCreatedAtResolver<TParent>
  actors?: CollectionNoticeToActorsResolver<TParent>
  target?: CollectionNoticeToTargetResolver<TParent>
}

export interface CollectionNoticeToIdResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface CollectionNoticeToUnreadResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CollectionNoticeToCreatedAtResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CollectionNoticeToActorsResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface CollectionNoticeToTargetResolver<
  TParent = any,
  TResult = any
> {
  (
...
export interface GQLMomentNoticeTypeResolver<TParent = any> {
  id?: MomentNoticeToIdResolver<TParent>
  unread?: MomentNoticeToUnreadResolver<TParent>
  createdAt?: MomentNoticeToCreatedAtResolver<TParent>
  actors?: MomentNoticeToActorsResolver<TParent>
  type?: MomentNoticeToTypeResolver<TParent>
  target?: MomentNoticeToTargetResolver<TParent>
}

export interface MomentNoticeToIdResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentNoticeToUnreadResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentNoticeToCreatedAtResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentNoticeToActorsResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentNoticeToTypeResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
...
export interface MomentNoticeToTargetResolver<TParent = any, TResult = any> {
  (
    parent: TParent,
    args: {},
    context: Context,
