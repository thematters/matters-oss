...
import withTogglePublic, { ChildProps } from './withTogglePublic'

type TogglePublicState = {
  checked: boolean
  loading: boolean
  error: any
}

class TogglePublic extends React.Component<ChildProps, TogglePublicState> {
...
export default withTogglePublic(TogglePublic)
